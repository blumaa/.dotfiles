...
plugins=(zsh-autosuggestions asdf zsh-syntax-highlighting rails)
...
alias vim='nvim'
alias xboard='cd ~/Development/xboard/xboard'
alias xcrm='cd ~/Development/xboard/xcrm'
alias xsurance='cd ~/Development/xsurance'
